...
export default function About_2() {
    return(
        <div className="flex flex-col justify-center items-center h-full">
            ...
            <h1 className="font-bold text-3xl">ABOUT SPERING COMPANY</h1>
            <p className="text-center mx-20 mt-7">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in somle form, by injected humour, or randomised words which don't look even slightly believable. If youThere are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you</p>
